...
public class Client {
	...
	public static void send(Packet p) throws IOException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, ShortBufferException, BadPaddingException{
		p.send(thread.getOutputStream());
	}
